    ...
    <section className="pb-24 pt-8">
      <div className="container mx-auto px-6">
        <motion.div
          ...
          className="relative mx-auto max-w-3xl overflow-hidden rounded-3xl border border-primary/20 bg-gradient-to-br from-primary/10 via-accent/5 to-primary/10 px-8 py-16 text-center backdrop-blur-sm"
        >
          ...
          <div className="mt-8 flex flex-col items-center justify-center gap-4 sm:flex-row">
            <Button
              size="lg"
              className="rounded-xl px-8 transition-all duration-300 hover:scale-105 hover:shadow-xl hover:shadow-primary/30"
              asChild
            >
              <Link href="/practice">
                Start Practicing
